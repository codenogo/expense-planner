...
func (_q *UserQuery) QueryMembers() *HouseholdMemberQuery {
...
func (_q *UserQuery) WithMembers(opts ...func(*HouseholdMemberQuery)) *UserQuery {
	query := (&HouseholdMemberClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *User) { n.Edges.Members = []*HouseholdMember{} },
			func(n *User, e *HouseholdMember) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range _q.withNamedMembers {
		if err := _q.loadMembers(ctx, query, nodes,
			...
			func(n *User, e *HouseholdMember) { n.appendNamedMembers(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadMembers(ctx context.Context, query *HouseholdMemberQuery, nodes []*User, init func(*User), assign func(*User, *HouseholdMember)) error {
...
func (_q *UserQuery) WithNamedMembers(name string, opts ...func(*HouseholdMemberQuery)) *UserQuery {
	query := (&HouseholdMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
