...
func (_c *TagCreate) SetHouseholdID(id int) *TagCreate {
...
func (_c *TagCreate) AddTransactionIDs(ids ...int) *TagCreate {
	_c.mutation.AddTransactionIDs(ids...)
	return _c
}

// AddTransactions adds the "transactions" edges to the Transaction entity.
func (_c *TagCreate) AddTransactions(v ...*Transaction) *TagCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TagCreate) check() error {
	...
	if len(_c.mutation.HouseholdIDs()) == 0 {
		return &ValidationError{Name: "household", err: errors.New(`ent: missing required edge "Tag.household"`)}
	}
	return nil
}
