...
import { ADD_EXPENSE_MUTATION } from '@/graphql/transactions'
...
import { ArrowDownRight, DollarSign, FileText, Tag, CalendarIcon, Search, Check } from 'lucide-react'
...
export function AddExpensePage() {
  ...
  const [addExpense, { loading, error }] = useMutation<
